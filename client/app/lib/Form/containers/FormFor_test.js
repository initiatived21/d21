...
describe('FormFor', function() {
  ...
  describe('with submit spy', function() {
    it('should have an onSubmit function', function() {
      const spyProps = Object.assign({}, props, {
        onSubmit: sinon.spy()
      });

      const wrapper = mount(React.createElement(FormFor, spyProps));
  ...
  describe('with non-Input children', function() {
    ...
    it('should render the children without model prop', function() {
      ...
      assert(div.first().props().model === undefined);
    });
  });
