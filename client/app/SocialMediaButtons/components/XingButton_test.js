...
describe('<XingButton />', function () {
  ...
  it('should render', function () {
    const wrapper = shallow(<XingButton {...props} />);
  ...
  it('should link to the correct URL', function () {
    ...
    href.should.equal('https://www.xing.com/social_plugins/share?url=http%3A%2F%2Fwww.example.com');
  });
});
